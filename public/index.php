...
$router->get('/informacion',[HomeController::class, "informacion"]);
$router->post('/informacion',[HomeController::class, "informacion"]);
$router->get('/modelos',[HomeController::class, "modelos"]);
$router->post('/modelos',[HomeController::class, "modelos"]);
$router->get('/contacto',[HomeController::class, "contacto"]);
$router->post('/contacto',[HomeController::class, "contacto"]);
$router->get('/servicios',[HomeController::class, "servicios"]);
$router->post('/servicios',[HomeController::class, "servicios"]);
