      ...
      <div class="row">
        <div class="col-md-12">
          <div class="title-area">
            <h2 class="title">Crea una cuenta de <span>empresa</span></h2>
          </div>
        </div>
        <div class="col-md-12">
          <div class="features-area">
            ...
            <form action="" class="contact-form" method="post">
              ...
              <input class="form-control" type="text" name="nombre" id="nombre" value="<?php echo s($empresa->nombre); ?>" placeholder="Tu nombre">
              </div>
              <div class="form-group">
              <label>Contacto:</label>
              <input class="form-control" type="text" name="contacto" id="contacto" value="<?php echo s($empresa->contacto); ?>" placeholder="Tu nombre">
              </div>
              <div class="form-group">
